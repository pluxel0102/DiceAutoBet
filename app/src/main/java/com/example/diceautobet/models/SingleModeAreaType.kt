...
enum class SingleModeAreaType(val displayName: String, val description: String) {
    ...
    // Области для прокрутки списка ставок
    FOUR_CLICKS_AREA("4 нажатия вправо", "Область для прокрутки к ставке 200,000 (4 нажатия вправо)"),
    FOUR_CLICKS_LEFT("4 нажатия влево", "Область для возврата к начальной ставке (4 нажатия влево)");
